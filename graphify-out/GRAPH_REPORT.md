...
## Corpus Check
- Corpus is ~21,775 words - fits in a single context window. You may not need a graph.
...
Cohesion: 0.15
Nodes (16): bookingConfig, EnvironmentInterface, GoogleCredentials, BookingConfig, BookingDetails, BusyBlock, DurationOption, StoredBooking (+8 more)
...
### Community 9 - "cli"
Cohesion: 0.12
Nodes (17): cli, analytics, devDependencies, @angular/build, @angular/cli, @angular/compiler-cli, jasmine-core, karma (+9 more)

### Community 11 - "package.json"
Cohesion: 0.15
Nodes (12): name, private, scripts, build, prebuild, prestart, serve:ssr:portfolio, setenv (+4 more)
